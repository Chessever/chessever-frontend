  ...
  group('resolveNotationClassification (data present ⇒ markers)', () {
    test(
      ...
      () {
        ...
        // Drive the same pure resolve path notation chips use once the
        // FutureProvider has delivered a non-empty map.
        ...
        // Unannotated mainline index stays null.
        expect(
    ...
    test(
      ...
      () {
        ...
        // Simulate Future completing with report data (no tap/rebuild gesture
        // required — pure resolve on the new map is enough).
        annotations = {
    ...
    test('raw PGN mode suppresses Lichess classifications', () {
      final annotations = <int, LichessMoveAnnotation>{
        0: const LichessMoveAnnotation(
