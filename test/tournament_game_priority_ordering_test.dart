...
void main() {
  ...
  group('focus on live games order', () {
    ...
    test(
      ...
      () {
        // Focus mode derives liveness from the boards it is handed on every
        // rebuild, so a board that finishes leaves the live tier on that tick.
        ...
        // 2. Board 2 finishes and drops back to its board-number slot.
        ...
        // 3. The last live board finishes — full normal order returns.
