...
void main() {
  ...
  testWidgets('opponent name opens the performance card, not the game', (
    tester,
  ) async {
    ...
    final playerName = find.byWidgetPredicate(
      (widget) =>
          widget is RichText &&
          widget.text.toPlainText() == 'WGM Pourkashiyan, Atousa',
    );
  ...
  testWidgets('rating, elo change and result still open the game', (
    tester,
  ) async {
    var performanceOpens = 0;
    var gameOpens = 0;
