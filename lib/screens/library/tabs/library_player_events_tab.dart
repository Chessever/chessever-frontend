...
/// Events tab for library player profile - shows tournaments the player has participated in
class LibraryPlayerEventsTab extends ConsumerStatefulWidget {
  const LibraryPlayerEventsTab({
    super.key,
  ...
  @override
  ConsumerState<LibraryPlayerEventsTab> createState() =>
      _LibraryPlayerEventsTabState();
}

class _LibraryPlayerEventsTabState extends ConsumerState<LibraryPlayerEventsTab>
  ...
  Widget build(BuildContext context) {
    ...
    final eventsAsync = ref.watch(playerEventsKeyProvider(_playerProfileKey));
    ...
    return RefreshIndicator(
      onRefresh: () async {
        ...
        if (_fideIdInt != null) {
          ref.invalidate(playerEventCardsProvider(_fideIdInt!));
        }
      },
      color: kWhiteColor,
