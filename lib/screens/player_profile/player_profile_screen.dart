    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          // Flag, title, and natural display name beside the primary follow
          // action. Unknown federations render no placeholder.
          Expanded(
            child: Center(
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  if (effectiveFederation?.trim().isNotEmpty ?? false) ...[
                    FederationFlag(
