...
class PlayerFirstRowDetailWidgetNew extends HookConsumerWidget {
  final bool isCurrentPlayer;
  final PlayerView playerView;
  final GamesTourModel gamesTourModel;
  final bool isWhitePlayer;
  ...
  const PlayerFirstRowDetailWidgetNew({
    super.key,
    required this.playerView,
    required this.isWhitePlayer,
    required this.gamesTourModel,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    // Calculate move time from moveTimes list
    final moveTime = useMemoized(() {
      ...
      return isWhitePlayer
          ? gamesTourModel.whiteTimeDisplay
          : gamesTourModel.blackTimeDisplay;
    }, [moveTimes, currentMoveIndex, isWhitePlayer, gamesTourModel]);
    ...
    // Determine if we're showing scores (simplified without chessBoardState)
    ...
    return GestureDetector(
      ...
      child: Row(
        ...
        children: [
          ...
          // Show score for finished games or time otherwise
          isShowingScore
              ? Container(
                  padding: EdgeInsets.symmetric(horizontal: 4.sp),
                  decoration: BoxDecoration(
              ...
              : _PlayerClock(
                  isWhitePlayer: isWhitePlayer,
                  gamesTourModel: gamesTourModel,
                  chessBoardState: null, // No longer needed
                  isCurrentPlayer: isCurrentPlayer,
                  timeStyle: timeStyle,
                  moveTime: moveTime,
                ),
