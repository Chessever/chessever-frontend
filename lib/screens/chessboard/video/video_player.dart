  ...
  Future<void> _initialize() async {
    ...
    if (controller.platform is AndroidWebViewController) {
      ...
      await android.setCustomWidgetCallbacks(
        onShowCustomWidget:
            (view, onHidden) => enterFullscreen(view, onHidden),
...
function onYouTubeIframeAPIReady() {
  const ytPlayer=new YT.Player('player', {width:'100%', height:'100%', videoId:$id,
    playerVars:{autoplay:${play ? 1 : 0}, playsinline:1, origin:$parent, mute:${muted ? 1 : 0}, controls:${controls ? 1 : 0}, modestbranding:1, rel:0, iv_load_policy:3},
