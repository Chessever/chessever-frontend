...
class ChessBoardScreen extends ConsumerStatefulWidget {
  final List<ChessBoardFenModel> games;
        ...
        itemBuilder: (context, index) {
          ...
          return Scaffold(
            ...
            appBar: ChessMatchAppBar(
              title: '${game.gmName} vs ${game.gmSecondName}',
              onBackPressed: () {
              ...
              child: Column(
                children: [
                  ...
                  PlayerFirstRowDetailWidget(
                    name: widget.games[index].gmName,
                    firstGmRank: widget.games[index].firstGmRank,
                    countryCode: widget.games[index].firstGmCountryCode,
                    // flagAsset: 'assets/usa_flag.png',
                    time: widget.games[index].firstGmTime,
                  ),
                  ...
                  PlayerSecondRowDetailWidget(
                    name: widget.games[index].gmSecondName,
                    countryCode: widget.games[index].secondGmCountryCode,
                    time: widget.games[index].secondGmTime,
                    secondGmRank: widget.games[index].secondGmRank,
                  ),
