      ...
      child: CustomScrollView(
        ...
        slivers: [
          SliverToBoxAdapter(
            child: Column(
              children: [
                // Only the search row is inset here. The filter strips scroll
                // horizontally and carry their own internal padding, so they
        ...
        delegate: SliverChildBuilderDelegate((context, index) {
          ...
          return LiftedRowMenu(
            ...
            child: FigmaPlayerCard(
              ...
              // 1..n would claim a world rank the player does not hold.
