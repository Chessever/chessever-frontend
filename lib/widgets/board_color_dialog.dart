...
class BoardColorBottomSheet extends ConsumerWidget {
  const BoardColorBottomSheet({Key? key}) : super(key: key);

  // Static method to show the bottom sheet with blur effect
  static Future<void> show(BuildContext context) {
    return showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
      isScrollControlled: true,
      // Enable dismiss when tapping outside
      isDismissible: true,
      ...
      builder:
          (context) => BackdropFilter(
            ...
            child: const BoardColorBottomSheet(),
          ),
    );
  }
