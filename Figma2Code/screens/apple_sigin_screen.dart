...
class _AppleSignInScreenState extends State<AppleSignInScreen> {
  ...
  void _signIn() {
    ...
    if (_appleIdController.text.isEmpty || _passwordController.text.isEmpty) {
      setState(() {
        _error = 'Apple ID and password are required.';
      });
      return;
    }
          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text('Apple Sign In', style: TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
                  SizedBox(height: 32),
                  TextField(
                  ...
                  ElevatedButton(
                    ...
                    onPressed: _signIn,
                    child: Text('Sign In with Apple', style: TextStyle(fontWeight: FontWeight.w600)),
                  ),
                ],
              ),
            ),
