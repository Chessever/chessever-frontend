...
provider's fullscreen button opens its WebView custom view in an overlay above
the route. Both viewers rotate their content to landscape on portrait phones. Back exits fullscreen first, then the expanded viewer, then the route.
